...
//        timeUntilNextAlien = 5000; // in milliseconds
...
//
//                timeUntilNextAlien = (int) (Math.random() * 5000 + 5000); // between 5 and 10 seconds
//                alienTimer.schedule(this, timeUntilNextAlien);
//            }
//        }, timeUntilNextAlien);
        Alien alien = new Alien((int)Math.random() * WIDTH, (int)Math.random()* HEIGHT);
...
//            	long timeSinceLastAsteroid = now - lastAsteroidTime;
//            	if (timeSinceLastAsteroid > timeBetweenAsteroids) {
//                    lastAsteroidTime = now;
//
//                    // add a new alien to the game
//                    Random rnd = new Random();
//                    Alien alien = new Alien(rnd.nextInt(WIDTH / 3), rnd.nextInt(HEIGHT));
//                    pane.getChildren().add(alien.getCharacter());
//                    alien.move();
//                    
//                }
